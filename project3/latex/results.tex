...
\begin{figure}
    ...
    \caption{The trajectory of Particle 1 (blue) and Particle 2 (orange) in the Penning trap for 50 \textmu s. The left panel shows the situation when we neglect interaction forces, whilst the right panel introduces these forces. The staring points of their trajectories are indicated with a cross, their ending points with a star.}
...
\begin{figure}
    ...
    \caption{Fraction of particles that are still trapped by the Penning trap after a period $T_2$, as function of the applied frequency $\omega_V$, for different amplitudes $f\in\{0.1, 0.4, 0.7\}$, without considering particle interactions. All graphs are resulting from simulations using 80000 time steps.}
...
\begin{figure}
    ...
    \caption{Fraction of particles that are still trapped by the Penning trap after a period $T_2$, as function of selected applied resonance frequencies $\omega_V$, with amplitude $f=0.1$, both with and without particle interactions. Both graphs are resulting from simulations using 20000 time steps.}
