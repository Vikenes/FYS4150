...
\subsection{\Nanna{(appropriate title)} Numerical implementation and integration \Johan{appropriate enough?}}\label{sec:code}
...
\end{equation}
where $h_k =T_1/n_k$ is the step size an
