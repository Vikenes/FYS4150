...
For $T=2.4\tunit$, we see in the right panel of Fig. \ref{fig:histogram} that the energy of the system is distributed over a larger range, with $\avge\approx-1.24\eunit$ and $\sigma(\eps)^2 \approx2.03\cdot10^{-2}\eunit$. \Vetle{Elaborate a bit more: more microstates with same energy, blablabla}
\begin{figure}[!ht]
...
\begin{figure}[!ht]
    \includegraphics[width=\linewidth]{temp/critical_temperatures.png} 
