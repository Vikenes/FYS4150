...
\subsection{Periodic boundaries}\label{sec:methods:periodic_boundaries}
    \Nanna{Dirichlet}

\subsection{Initial wave packet}\label{sec:methods:initial_wave}
...
\subsection{Slit configuration}\label{sec:methods:slit_config}
...
\subsection{Artificial detector screen}\label{sec:methods:screen}
...
\subsection{Simulations}\label{sec:methods:simulation_parameters}
