...
\subsection{Simulation}
    ...
    \end{split}
    \end{equation}
    where $\Sigma = \mathrm{diag}(\svec{\sigma}^2)$, $\vec{x}_c$ and $\vec{p}$ are the spatial variance, spatial centre location and momentum of the initial wave packet. This is a two dimensional complex Gaussian function. 
