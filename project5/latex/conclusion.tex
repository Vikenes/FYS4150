...
The scattering pattern on the detector screen is consistent with experimental results, e.g. Young's experiment. Our results substantiate the Born rule \Nanna{(Rephrase!)}.
